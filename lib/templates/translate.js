...
export default {
    ...
    */
    getTranslation (msgid, n = 1, context = null, defaultPlural = null, language = options.defaultLanguage) {
        if (!msgid) {
        ...
        const translations = this.translations[language] || this.translations[language.split('_')[0]]
        ...
        if (!(Array.isArray(translated)) && translated.hasOwnProperty('')) {
